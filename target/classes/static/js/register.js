        ...
        function errorMsg(name) {
            document.querySelector(`#${name}Msg`).classList.add("alert-danger");
        }

        function successMsg(name) {
            document.querySelector(`#${name}Msg`).classList.add("alert-success");
        }

        function deleteStyle(name) {
            document.querySelector(`#${name}Msg`).innerHTML = "";
            document.querySelector(`#${name}Msg`).classList.remove("alert-danger");
            document.querySelector(`#${name}Msg`).classList.remove("alert-success");
        }



        function checkUserName(response) {
            document.querySelector("#userNameMsg").innerHTML = response.data.message;
        ...
        function userNameBlurOperation() {
            ...
            if (value == "") {
                document.querySelector("#userNameMsg").innerHTML = "用户名不能为空！";
                errorMsg("userName");
            } else if (!reg.test(value)) {
                document.querySelector("#userNameMsg").innerHTML = "用户名不能为中文！";
                errorMsg("userName");
            } else if (value.length < 5) {
                document.querySelector("#userNameMsg").innerHTML = "用户名长度不能小于5！";
                errorMsg("userName");
            } else {
        ...
        function nickNameBlurOperation() {
            ...
            if (value == "") {
                document.querySelector("#nickNameMsg").innerHTML = "用户名不能为空！";
                errorMsg("nickName");
            } else if (value.length < 2) {
                document.querySelector("#nickNameMsg").innerHTML = "用户名长度不能小于5！";
                errorMsg("nickName");
            } else {
                document.querySelector("#nickNameMsg").innerHTML = "输入符合要求！";
                successMsg("nickName");
            }
        }
        ...
        function passwordBlurOperation() {
            ...
            if (value == "") {
                document.querySelector("#passwordMsg").innerHTML = "用户名不能为空！";
                errorMsg("password");
            } else if (value.length < 6) {
                document.querySelector("#passwordMsg").innerHTML = "用户名长度不能小于6！";
                errorMsg("password");
            } else {
                document.querySelector("#passwordMsg").innerHTML = "密码输入符合要求！";
                successMsg("password");
            }
        }
        ...
        function rePasswordBlurOperation() {
            ...
            if (rePassword == "") {
                document.querySelector("#rePasswordMsg").innerHTML = "用户名不能为空！";
                errorMsg("rePassword");
            } else if (password !== rePassword) {
                document.querySelector("#rePasswordMsg").innerHTML = "两次输入的密码不相同！";
                errorMsg("rePassword");
            } else {
                document.querySelector("#rePasswordMsg").innerHTML = "密码输入符合要求！";
        ...
        function emailBlurOperation() {
            ...
            if (value.length == 0) {
                document.querySelector("#emailMsg").innerHTML = "邮处地址不能不为空！";
                errorMsg("email");
            } else if (!regExp.test(value)) {
                document.querySelector("#emailMsg").innerHTML = "邮箱地址格式错误！";
                errorMsg("email");
            } else {
                document.querySelector("#emailMsg").innerHTML = "邮箱地址格式符合要求！";
                successMsg("email");
            }
        }
        ...
        function photoBlurOperation() {
            ...
            if (value.length == 0) {
                document.querySelector("#photoMsg").innerHTML = "手机号不能不为空！";
                errorMsg("photo");
            } else if (!regExp.test(value)) {
                document.querySelector("#photoMsg").innerHTML = "手机号输入错误！";
                errorMsg("photo");
            } else {
                document.querySelector("#photoMsg").innerHTML = "手机号符合要求！";
                successMsg("photo");
            }
        }
